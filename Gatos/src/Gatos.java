...
public class Gatos extends PApplet {
        ...
        */
        LinkedList<Gato> generaSucesores(){
          ...
          if(!hayGanador){
            for(int i=0;i<3;i++)
               for(int j=0;j<3;j++){
                Gato gato = new Gato(this);
                gato.jugador1=!jugador1;
                if(tablero[i][j]==0){
                      gato.tiraEn(j,i); 
                      gato.padre=this;
    ...
    /** Al reflejar el gato sobre la diagonal \ son iguales (ie traspuesta) */
        ...
        boolean esSimetricoDiagonal(Gato otro){
         ...
         return false;      
         else if(tablero [0][1]!=otro.tablero[1][2])
         return false;
         else if(tablero [0][2]!=otro.tablero[0][2])
         return false;
         else if(tablero [1][0]!=otro.tablero[2][1])
         return false;
         else if(tablero [1][1]!=otro.tablero[1][1])
         return false;
         else if(tablero [1][2]!=otro.tablero[0][1])
         return false;
         else if(tablero [2][0]!=otro.tablero[2][0])
         return false;
         else if(tablero [2][1]!=otro.tablero[1][0])
         return false;
         else if(tablero [2][2]!=otro.tablero[0][0])
         return false;
        ...
        if(tablero [0][0]!=otro.tablero[0][2])
         return false;      
         else if(tablero [0][1]!=otro.tablero[0][1])
         return false;
         else if(tablero [0][2]!=otro.tablero[0][0])
         return false;
         else if(tablero [1][0]!=otro.tablero[1][2])
         return false;
         else if(tablero [1][1]!=otro.tablero[1][1])
         return false;
         else if(tablero [1][2]!=otro.tablero[1][0])
         return false;
         else if(tablero [2][0]!=otro.tablero[2][2])
         return false;
         else if(tablero [2][1]!=otro.tablero[2][1])
         return false;
         else if(tablero [2][2]!=otro.tablero[2][0])
         return false;
        ...
        boolean esSimetricoHorizontalmente(Gato otro){
         ...
         return false;      
         else if(tablero [0][1]!=otro.tablero[2][1])
         return false;
         else if(tablero [0][2]!=otro.tablero[2][2])
         return false;
         else if(tablero [1][0]!=otro.tablero[1][0])
         return false;
         else if(tablero [1][1]!=otro.tablero[1][1])
         return false;
         else if(tablero [1][2]!=otro.tablero[1][2])
         return false;
         else if(tablero [2][0]!=otro.tablero[0][0])
         return false;
         else if( tablero [2][1]!=otro.tablero[0][1])
         return false;
         else if(tablero [2][2]!=otro.tablero[0][2])
         return false;
        ...
        boolean esSimetrico90(Gato otro){
         if(tablero [0][0]!=otro.tablero[2][0])
         return false;      
         else if(tablero [0][1]!=otro.tablero[1][0])
         return false;
         else if(tablero [0][2]!=otro.tablero[0][0])
         return false;
         else if(tablero [1][0]!=otro.tablero[2][1])
         ...
         return false;
         else if(tablero [2][1]!=otro.tablero[1][2])
         return false;
         else if(tablero [2][2]!=otro.tablero[0][2])
         return false;
        ...
        boolean esSimetrico180(Gato otro){
         ...
         return false;
         else if(tablero [0][2]!=otro.tablero[2][0])
         return false;
         else if(tablero [1][0]!=otro.tablero[1][2])
         return false;
         else if(tablero [1][1]!=otro.tablero[1][1])
         ...
         return false;
         else if(tablero [2][0]!=otro.tablero[0][2])
         return false;
         else if(tablero [2][1]!=otro.tablero[0][1])
         return false;
         else if(tablero [2][2]!=otro.tablero[0][0])
        ...
        boolean esSimetrico270(Gato otro){
         ...
         return false;
         else if(tablero [1][0]!=otro.tablero[0][1])
         return false;
         else if(tablero [1][1]!=otro.tablero[1][1])
         return false;
         else if(tablero [1][2]!=otro.tablero[2][1])
         return false;
         else if(tablero [2][0]!=otro.tablero[0][0])
         return false;
         else if(tablero [2][1]!=otro.tablero[1][0])
