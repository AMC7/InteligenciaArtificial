    ...
    class ModeloTermitas{
      ...
      */
      boolean hayAstilla(Termita t, int direccion){
         ...
         int posY=t.posY;
         switch(direccion) {
          case 0:  posX = (posX-1)%ancho;
                   if(posX < 0) posX += ancho;
                   posY = (posY-1)%alto;
                   if(posY < 0) posY += alto;
                   return mundo[posY][posX].estado;
                 
          case 1:  posY = (posY-1)%alto;
                   if(posY < 0) posY += alto;
                    return mundo[posY][posX].estado;
                  
          case 2:  posX = (posX+1)%ancho;
                   if(posX < 0) posX += ancho;
                   posY = (posY-1)%alto;
                   if(posY < 0) posY += alto;
                   return mundo[posY][posX].estado;
          case 3:  posX = (posX+1)%ancho;
                   if(posX < 0) posX += ancho;
                    return mundo[posY][posX].estado;
          case 4:  posX = (posX+1)%ancho;
                   if(posX < 0) posX += ancho;
                   posY = (posY+1)%alto;
                   if(posY < 0) posY += alto;
                   return mundo[posY][posX].estado;
          case 5:  posY = (posY+1)%alto;
                   if(posY < 0) posY += alto;
                   return mundo[posY][posX].estado;
          case 6:  posX = (posX-1)%ancho;
                   if(posX < 0) posX += ancho;
                   posY = (posY+1)%alto;
                   if(posY < 0) posY += alto;
                   return mundo[posY][posX].estado;
          case 7:  posX = (posX-1)%ancho;
                   if(posX < 0) posX += ancho;
                    return mundo[posY][posX].estado;
        }
          return false;
      ...
      */
      void tomarAstilla(Termita t, int direccion){
       ...
       Termita temp=t;
       this.moverTermita(t, direccion);
       t.cargando=true;
       mundo[temp.posY][temp.posX].estado=false;
